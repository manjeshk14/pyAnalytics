...
mtcarsDF.isna() #to find missing values and it is written na
mtcarsDF.notna()  #missing values
id(mtcarsDF)
mtcars.empty
mtcars.size
mtcars.ndim
...
#set of values : loc : index values # ERROR
mtcarsDF.index
...
mtcarsDF.iloc[1:10, 1:5] #2nd row to 10th row nad 2nd column to 5th column
mtcarsDF.iloc[1:10:2, 1:5:2]  #2nd row to 10th row nad 2nd column to 5th column with skipping 1 in between
...
#%%filter
#condition
mtcarsDF['gear'] == 3  #T&F checking for 3 geared cars
