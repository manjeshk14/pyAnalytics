...
list(y)
#split X and y
X_train, X_test, y_train, y_test = train_test_split( X, y, test_size= 0.33, random_state=42) # change random state to get new pattern
X_train
y_train
X_test
y_test
...
#%%% another way of dividing the sets into training and test set with know % using iris
from sklearn.model_selection import train_test_split
